      ...
      <div className="row d-flex justify-content-between">
        <div className="col-12 col-md-6 text-white d-flex align-items-center text-start">
          <div className="ms-5 me-3 top-text">
            <h2 className="mt-3 text-capitalize fs-1 fw-medium">
              Get In Touch With Friends And Families
            </h2>
            <p className="fs-5">
              Share your memories with friends and family, get in touch every
              day.
            </p>
            <button
              className="ms-2 px-3 mt-3 rounded-2 fs-5 pb-1 text-white"
      ...
      <div className="row d-flex justify-content-between">
        ...
        <div className="col-12 col-md-6 text-white d-flex align-items-center text-start">
          <div className=" me-3 pe-2 top-text">
            ...
            <p className="fs-5">
              Share your memories with friends and family, ouch every day.
            </p>
            <button
              className="ms-2 px-3 mt-3 rounded-2 fs-5 pb-1 text-white"
              style={{ backgroundColor: "#01A982" }}
